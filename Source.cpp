...
// to Jacobi method
const Matrix exampleIntegPoints = {{-0.57735, -0.57735}, {0.57735,-0.57735}, {0.57735,0.57735}, {-0.57735, 0.57735}};
...
int main() {
	...
	JacobiMethod jaca(exampleIntegPoints);
	jaca.executeJacobiMethod();
	jaca.getOutput();
